...
const DoorSVG = (props) => {
  return (
    <div className={classes.doorSVG}>
      <svg
        width={props.maxPosition + 272}
        height={props.maxPosition + 470}
        className={classes.path_1_wrap}
        viewBox="0 -2 272 470"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
        opacity={(1400 - props.maxPosition) / props.maxPosition}
        // style={{ display: `${props.visiblePosition ? "block" : "none"}` }}
      >
      ...
      <svg
        width={props.maxPosition + 366}
        height={props.maxPosition + 563}
